...
//////////////
// rhoe: include input callback functions here
//////////////
...
void ImGui_ImplGlfwGL3_MouseButtonCallback(GLFWwindow*, int button, int action, int /*mods*/)
{
    ...
    // rhoe: if imgui doesnt want input dispatch it to me
    ImGuiIO& io = ImGui::GetIO();
    if(!io.WantCaptureMouse) {
        mouse_button_callback(g_Window, button, action);
    }
...
void ImGui_ImplGlfwGL3_KeyCallback(GLFWwindow*, int key, int, int action, int mods)
{
    ...
    if(!io.WantCaptureKeyboard) {
        key_callback(g_Window, key, action, mods);
    }
...
void ImGui_ImplGlfwGL3_NewFrame()
{
    ...
    // rhoe: dont let imgui control mouse when we capture the mouse
